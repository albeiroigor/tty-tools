#!/usr/bin/env python3
"""
nmtui-l — Interfaz TUI para gestión de redes en Hyprland/Linux
Versión mejorada: seguridad, parseo robusto, contraseñas ocultas, interfaz refinada.
Requiere: python3, NetworkManager (nmcli), iproute2
Uso: python3 nmtui-lite.py
"""
